...
angular.module("Winterest").controller("PinsListCtrl", function ($scope, ImgFactory, $routeParams) {
    ...
    console.log("this is the board id", $routeParams.boardId);
    console.log("this should be a promise", ImgFactory.getPinList);
    ImgFactory.getPinList($routeParams.boardId)
    .then((data) => {
        console.log("this is what you're getting in the pinned images controller", data);
    });
    // LOAD PINS
